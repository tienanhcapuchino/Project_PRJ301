...
public class DAOSalesDetail extends ConnectDB {
    ...
    public int updateSalesDetail(String storeID,String orderNumber,int status) {
        int n = 0;
        String sql = "UPDATE [sales] SET [status] = ? WHERE [stor_id] = '" + storeID + "' AND [ord_num] = '" + orderNumber + "'";
        try {
