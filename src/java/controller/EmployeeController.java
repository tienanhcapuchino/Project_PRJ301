    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (service) {
                ...
                default:
                    Vector<employee> vector = dao.viewAllEmployee();
                ...
                case "insertEmployee":
                    ...
                    if (submitInsert == null) {
                        out.println("<head>\n"
                                ...
                                + "    </head>");
                        out.printf("<form action='EmployeeController' method='post'>\n"
                                + "            <table class='table'>\n"
                                + "                <tr>\n"
                        ...
                        out.print("                 </select>\n"
                                ...
                                + "                <tr>\n"
                                + "                    <td>\n"
                                + "                        <input class='form-control' type='submit' value='Insert to Database'>\n"
                                + "                    </td>\n"
                                + "                    <td>\n"
                                + "                        <input class='form-control' type='submit' value='Go Back'>\n"
                                + "                    </td>\n"
                                + "                    <td>\n"
                ...
                case "deleteEmployee":
                    ...
                    if (submitDelete == null) {
                        ...
                        if (rs.next()) {
                            ...
                            out.println("<tr>");
                            out.println(" <td>");
                            out.println("  <input class='form-control' type='submit' value='Yes' name='submitDelete'>");
                            out.println(" </td>");
                            out.println(" <td>");
                            out.println("  <input class='form-control' type='submit' value='No & Back' name='submitDelete'>");
                            out.println(" </td>");
                            out.println("</tr> ");
                            out.println("</tbody>");
                            out.println("</table>");
