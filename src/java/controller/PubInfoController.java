        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (service) {
                ...
                default:
                    ...
                    request.setAttribute("TITLE", "Publisher Informations Manage");
                ...
                case "insertPubInfo":
                    ...
                    if (submitInsert == null) {
                        out.println("<head>\n"
                                ...
                                + "    </head>");
                        out.printf("<form action='PubInfoController' method='post'>\n"
                                + " <table class='table'>\n"
                                + " <tr>\n"
                        ...
                        out.print(" </select>\n"
                                ...
                                + " <tr>\n"
                                + "             <td>\n"
                                + "                 <button class='btn btn-outline-dark' type='submit' value='Insert to Database' name='submitInsert'>Insert PubInfo Database</button>\n"
                                + "             </td>\n"
                                + "             <td>\n"
                                + "                 <button class='btn btn-outline-dark' type='submit' value='Go Back' name='submitInsert'>Go Back</button>\n"
                                + "             </td>\n"
                                + "             <td>\n"
                        ...
                        switch (submitInsert) {
                            case "Insert to Database":
                                ...
                                pub_info ojb = new pub_info(pub_id, pr_desc);
                ...
                case "deletePubInfo":
                    ...
                    if (submitDelete == null) {
                        ...
                        if (rs.next()) {
                            ...
                            out.println("<tr>");
                            out.println(" <td>");
                            out.println(" <button class='btn btn-outline-dark' type='submit' value='Yes' name='submitDelete'>Yes</button>");
                            out.println(" </td>");
                            out.println(" <td>");
                            out.println(" <button class='btn btn-outline-dark' type='submit' value='No & Back' name='submitDelete'>No & Back</button>");
                            out.println(" </td>");
                            out.println("</tr> ");
                            out.println("</tbody>");
                            out.println("</table>");
