...
public class SaleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String status[] = {"All", "Wait", "Proccess", "Done"};
            ...
            switch (service) {
                default:
                    ...
                    Integer searchStatus = 0;
                    String test=request.getParameter("statusS");
                    if (test==null) {
                        searchStatus=0;
                    }else{
                        searchStatus=Integer.parseInt(test);
                    }
                    Vector<Sales> vector = dao.viewAllSales(username,searchStatus);
                ...
                case "insertSale":
                    ...
                    if (submitInsert == null) {
                        out.println("<head>\n"
                                ...
                                + "    </head>");
                        out.printf(" <form action='SaleController' method='post'> <table class='table'>\n"
                        ...
                        switch (submitUpdate) {
                            case "Update to Database":
                                ...
                                try {
                                    ...
                                    response.sendRedirect("SaleController?username="+store.getUserName());
                                } catch (Exception e) {
                                    response.sendRedirect("SaleController");
                                }
                                break;
                    ...
                    if (submitDelete == null) {
                        ...
                        if (rs.next()) {
                            ...
                            out.printf("                    </select></td>\n"
                                    ...
                                    + "                    <input class='form-control' type='hidden' id ='ordnum' name='ordnum' value='" + rs.getString(2) + "'></td>\n"
                                    + "                    </td>\n"
                                    + "                </tr>\n"
                                    + "                <tr>\n"
                                    + "                    <td><label for='orddate'>Order Date</label></td>\n"
