    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (service) {
                ...
                default:
                    Vector<TitleAuthor> vector = dao.viewAllTitleAuthor();
                ...
                case "insertTitleAuthor":
                    ...
                    if (submitInsert == null) {
                        out.println("<head>\n"
                                ...
                                + "    </head>");
                        out.printf("<form action='TitleAuthorController' method='post'>\n"
                                + "            <table class='table'>\n"
                                + "                <tr>\n"
                        ...
                        out.print("                 </select>\n"
                                ...
                                + "                <tr>\n"
                                + "                    <td>\n"
                                + "                        <input class='btn btn-outline-dark' type='submit' value='Insert to Database'>\n"
                                + "                    </td>\n"
                                + "                    <td>\n"
                                + "                        <input class='btn btn-outline-dark' type='submit' value='Go Back'>\n"
                                + "                    </td>\n"
                                + "                    <td>\n"
                ...
                case "deleteTitleAuthor":
                    ...
                    if (submitDelete == null) {
                        ...
                        if (rs.next()) {
                            ...
                            out.println("<tr>");
                            out.println(" <td>");
                            out.println("  <input class='btn btn-outline-dark' type='submit' value='Yes' name='submitDelete'>");
                            out.println(" </td>");
                            out.println(" <td>");
                            out.println("  <input class='btn btn-outline-dark' type='submit' value='No & Back' name='submitDelete'>");
                            out.println(" </td>");
                            out.println("</tr> ");
                            out.println("</tbody>");
                            out.println("</table>");
