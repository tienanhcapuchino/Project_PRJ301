...
<html>
    ...
    <body>
        ...
        <header>
            <div><strong>TIẾN ANH CAPUCHINO</strong>></div>
        </header>
        <div>
            <div>
            ...
            <div>
                ...
                <div>
                    <a href='StoreController?service=insertStore'><button>Insert Store</button></a>&emsp;
                    ...
                    <table border='1'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=temp.getState()%></td>
                                <td><%=temp.getZip()%></td>
                                <td><a href='SalesDetailController?storeID=<%=temp.getStor_id()%>'>Detail</a></td>
                                <td><a href='StoreController?service=updateStores&storeID=<%=temp.getStor_id()%>'>Update</a></td>
                                <td><a href='StoreController?service=deleteStores&storeID=<%=temp.getStor_id()%>'>Delete</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
