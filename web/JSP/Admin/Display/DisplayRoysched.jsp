    ...
    <body>
        ...
        <div>
            ...
            <div>
                ...
                <div>
                    <a href='RoyschedController?service=insertRoysched'><button>Insert Roysched</button></a>&emsp;
                    ...
                    <table border='1'>
                        ...
                        <tbody>
                            ...
                            if (rs1.next()) {%>
                                ...
                                <td><a href='RoyschedController?service=updateRoysched&titleID=<%=temp.getTitle_id()%>&royalty=<%=temp.getRoyalty()%>'>update</a></td>
                                <td><a href='RoyschedController?service=deleteRoysched&titleID=<%=temp.getTitle_id()%>&royalty=<%=temp.getRoyalty()%>'>Delete</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
